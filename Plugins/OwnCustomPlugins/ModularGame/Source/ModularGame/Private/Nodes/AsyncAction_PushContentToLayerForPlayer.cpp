...
#include "Nodes/AsyncAction_PushContentToLayerForPlayer.h"
...
UAsyncAction_PushContentToLayerForPlayer* UAsyncAction_PushContentToLayerForPlayer::PushContentToLayerForPlayer(APlayerController* InOwningPlayer, TSoftClassPtr<UCommonActivatableWidget> InWidgetClass, FGameplayTag InLayerName,
...
{
	if (UPrimaryLayoutWidget* RootLayout = UPrimaryLayoutWidget::GetPrimaryGameLayout(OwningPlayerPtr.Get()))
	{
