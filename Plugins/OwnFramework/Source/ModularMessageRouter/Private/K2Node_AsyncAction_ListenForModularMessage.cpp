...
#include "K2Node_AsyncAction_ListenForModularMessage.h"
...
void UK2Node_AsyncAction_ListenForModularMessage::PostReconstructNode()
{
...
void UK2Node_AsyncAction_ListenForModularMessage::PinDefaultValueChanged(UEdGraphPin* ChangedPin)
{
...
void UK2Node_AsyncAction_ListenForModularMessage::GetPinHoverText(const UEdGraphPin& Pin, FString& HoverTextOut) const
{
...
void UK2Node_AsyncAction_ListenForModularMessage::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
	struct GetMenuActions_Utils
	{
		static void SetNodeFunc(UEdGraphNode* NewNode, bool /*bIsTemplateNode*/, TWeakObjectPtr<UFunction> FunctionPtr)
		{
			UK2Node_AsyncAction_ListenForModularMessage* AsyncTaskNode = CastChecked<UK2Node_AsyncAction_ListenForModularMessage>(NewNode);
	...
	ActionRegistrar.RegisterClassFactoryActions<UAsyncAction_ListenForModularMessage>(FBlueprintActionDatabaseRegistrar::FMakeFuncSpawnerDelegate::CreateLambda([NodeClass](const UFunction* FactoryFunc)-> UBlueprintNodeSpawner*
	{
...
void UK2Node_AsyncAction_ListenForModularMessage::AllocateDefaultPins()
{
	Super::AllocateDefaultPins();

	//UAsyncAction_ListenForGameplayMessage委托的输出是一个代理对象，在触发时用于GetPayload的后续调用
	//这只需要在这个节点的内部使用，所以在编辑器中隐藏引脚。
...
bool UK2Node_AsyncAction_ListenForModularMessage::HandleDelegates(const TArray<FBaseAsyncTaskHelper::FOutputPinAndLocalVariable>& VariableOutputs, UEdGraphPin* ProxyObjectPin, UEdGraphPin*& InOutLastThenPin, UEdGraph* SourceGraph,
...
bool UK2Node_AsyncAction_ListenForModularMessage::HandlePayloadImplementation(FMulticastDelegateProperty* CurrentProperty, const FBaseAsyncTaskHelper::FOutputPinAndLocalVariable& ProxyObjectVar,
                                                                              const FBaseAsyncTaskHelper::FOutputPinAndLocalVariable& PayloadVar, const FBaseAsyncTaskHelper::FOutputPinAndLocalVariable& ActualChannelVar,
                                                                              UEdGraphPin*& InOutLastActivatedThenPin, UEdGraph* SourceGraph,
                                                                              FKismetCompilerContext& CompilerContext)
{
	bool bIsErrorFree = true;
	...
	if (PinType.PinCategory == UEdGraphSchema_K2::PC_Wildcard)
	{
		...
		{
			// 如果没有指定有效载荷类型，并且我们没有尝试将输出连接到任何东西，请忽略此步骤的其余部分
			return true;
		}
		else
		{
...
void UK2Node_AsyncAction_ListenForModularMessage::RefreshOutputPayloadType()
{
...
UEdGraphPin* UK2Node_AsyncAction_ListenForModularMessage::GetPayloadPin() const
{
...
UEdGraphPin* UK2Node_AsyncAction_ListenForModularMessage::GetPayloadTypePin() const
{
...
UEdGraphPin* UK2Node_AsyncAction_ListenForModularMessage::GetOutputChannelPin() const
{
